...
export default function CreateQuizModal({
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      await apiCreateQuiz(requestData);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-3xl p-0 overflow-hidden rounded-2xl gap-0 border-gray-100 [&>button]:hidden">
        {" "}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-2 border border-gray-200 rounded-xl overflow-hidden">
              ...
              <select
                {...register("questions_number" as any)}
                className="w-full bg-transparent px-2 py-2 focus:outline-none font-medium"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            ...
            <div className="flex items-center gap-2 border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                ...
                <option value="65c2bed779b859ea9320885f">Group 1</option>
              </select>
            </div>
          </div>
        </form>
