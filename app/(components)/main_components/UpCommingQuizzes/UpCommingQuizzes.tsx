    ...
    <div className="bg-white p-6 rounded-3xl shadow-lg w-full max-w-xl mx-auto border border-neutral-100">
      ...
      <div className="space-y-4">
        {quizData.map((quiz) => (
          ...
          <div key={quiz._id} className="flex border border-neutral-200 rounded-2xl overflow-hidden hover:border-neutral-300 hover:shadow-md transition-all duration-200">
            
            {/* The colored icon square on the left */}
            <div className={`flex-shrink-0 w-28 h-28 bg-light p-2 flex items-center justify-center`}>
              <div className="p-2 border-2 border-dashed border-orange-200 rounded-xl">
                 <Image width={100} height={100} src={quizLogo} alt="Quiz Icon" />
              </div>
            </div>
            ...
            <div className="grow p-4 pl-6 flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-neutral-500 mt-2">
                  No. of students enrolled : <span className="font-semibold text-neutral-800">{quiz.participants}</span>
                </p>
              </div>
