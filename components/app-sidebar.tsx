        ...
        <SidebarMenu>
          <SidebarMenuItem className="group-data-[state=collapsed]:mb-8 flex items-center justify-center">
            <SidebarMenuButton
              size={"lg"}
              asChild
              className={` py-12 pl-8 text-lg border-b border-gray-400 rounded-none  ${activeLink === "dashboard" && "border-r-8 border-dark group-data-[state=collapsed]:border-r group-data-[state=collapsed]:block"}`}
            >
              <Link
                href={`/${role}/dashboard`}
